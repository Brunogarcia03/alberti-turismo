...
import Carousel from "../components/ui/CarouselAnimado";
      ...
      <main className="md:min-h-screen bg-white relative z-[10]">
        <nav
          ...
          className="absolute top-0 left-1/2 -translate-x-1/2 
             ...
             border-x lg:border-r-0 border-l border-b border-black 
        ...
        <section className="py-28 lg:py-16 px-8 md:px-12 lg:px-24 flex flex-col gap-5 lg:flex-row lg:justify-between ">
          <div className="lg:w-[40%] h-full lg:sticky lg:top-5">
            <img
          ...
          <div className="lg:w-1/2 text-center lg:text-start mx-auto w-full pt-10">
            <h1 className="text-3xl md:text-5xl font-bold text-[#98217E]">
            ...
            <p className="mt-6 max-w-xl mx-auto lg:mx-0 text-lg md:text-2xl text-gray-700 text-justify">
              {description}
            </p>
          </div>
        </section>
